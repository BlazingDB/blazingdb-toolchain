...
macro(CONFIGURE_ZSTD_EXTERNAL_PROJECT)
    ...
    if(CXX_OLD_ABI)
        ...
        list(APPEND ZSTD_CMAKE_ARGS " -DCMAKE_C_FLAGS=-D_GLIBCXX_USE_CXX11_ABI=0")
        list(APPEND ZSTD_CMAKE_ARGS " -DCMAKE_CXX_FLAGS=-D_GLIBCXX_USE_CXX11_ABI=0")
    endif()

    # Download and unpack ZSTD at configure time
    configure_file(${CMAKE_CURRENT_LIST_DIR}/ZSTD.CMakeLists.txt.cmake ${CMAKE_BINARY_DIR}${CMAKE_FILES_DIRECTORY}/thirdparty/zstd-download/CMakeLists.txt)
