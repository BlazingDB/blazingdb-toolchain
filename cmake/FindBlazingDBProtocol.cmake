...
set(BlazingDBProtocol_FOUND ${BLAZINGDB_PROTOCOL_FOUND})
set(BlazingDBProtocol_INCLUDEDIR ${BLAZINGDB_PROTOCOL_INCLUDEDIR})
set(BlazingDBProtocol_INCLUDE_DIR ${BLAZINGDB_PROTOCOL_INCLUDE_DIR})
set(BlazingDBProtocol_STATIC_LIB ${BLAZINGDB_PROTOCOL_STATIC_LIB})

mark_as_advanced(
  BlazingDBProtocol_FOUND
  BlazingDBProtocol_INCLUDEDIR
  BlazingDBProtocol_INCLUDE_DIR
  #BLAZINGDB_PROTOCOL_LIBS
  BlazingDBProtocol_STATIC_LIB
  blazingdb-protocol
)
